...
public class PlayerController : MonoBehaviour
{
    ...
    private void Start() {
        ...
        // T to spawn more ghosts
        inputAction.Player.SpawnGhost.performed += cntxt => SpawnGhost();
    ...
    {
        Rigidbody ghostRb = ObjectPooler.instance.SpawnFromPool("Ghost", ghostSpawnPoint.transform.position, Quaternion.identity).GetComponent<Rigidbody>();
    }
